...
<style scoped>
  ...
  .swiper-slide:nth-child(4) a{
    background: url("../assets/img/d.jpg") no-repeat;
    background-size: 100% 100%;
  }
  .swiper-slide:nth-child(5) a{
    background: url("../assets/img/f.jpg") no-repeat;
    background-size: 100% 100%;
  }
